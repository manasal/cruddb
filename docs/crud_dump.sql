...
INSERT INTO `cities` VALUES (1,'Valencia'),(2,'Madrid'),(3,'Barcelona'),(4,'Barracas');
...
INSERT INTO `genders` VALUES (1,'hombre'),(2,'mujer'),(3,'otros');
...
CREATE TABLE `hobbies` (
  `idhobbie` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `hobbies` VALUES (1,'Cine'),(2,'Viajes'),(3,'Deportes'),(4,'Música'),(5,'Fotografía');
...
INSERT INTO `users` VALUES ('user1','Máriam','FFF@FFF','XXXX','desc','imag1.jpg','1981-03-01 01:30:00',1,2),('user2','Púa','pua@hot','1234','agaporni','pua.jpg','2013-09-04 00:00:00',1,2),('user3','Kira','kira@hot','1234','perra','kira.jpg','2007-08-15 00:00:00',1,2),('user4','Gui','gui@hot','1234','descrip','gui.jpg','1979-06-01 00:00:00',3,1),('user6','6','ada@djad','dsfasdf',NULL,NULL,NULL,2,2),('usuario5','5','5','5',NULL,NULL,NULL,1,1);
...
CREATE TABLE `users_has_hobbies` (
  `users_iduser` varchar(255) NOT NULL,
  `hobbies_idhobbie` int(11) NOT NULL,
  PRIMARY KEY (`users_iduser`,`hobbies_idhobbie`),
  KEY `fk_users_has_hobbies_hobbies1_idx` (`hobbies_idhobbie`),
  KEY `fk_users_has_hobbies_users1_idx` (`users_iduser`),
  CONSTRAINT `fk_users_has_hobbies_hobbies1` FOREIGN KEY (`hobbies_idhobbie`) REFERENCES `hobbies` (`idhobbie`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `users_has_hobbies` VALUES ('user1',1),('user3',1),('user2',2),('user1',3),('user2',4),('user4',4);
...
CREATE TABLE `usersdata` (
  ...
  `users_iduser` varchar(255) NOT NULL,
  PRIMARY KEY (`idusersdata`,`users_iduser`),
...
-- Dump completed on 2015-01-29 11:16:32
